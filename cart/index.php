                ...
                <div class="panel panel-default">
                    <div class="panel-body">
                        <div class="row product_image">
                            <img src="<?php echo $data['image'] ?>" width="80%" height="auto">
                        </div>
                        <div class="row product_name">
                            <h4><?php echo $data['name']; ?></h4>
                        </div>
                        <div class="row product_footer">
                            <p class="pull-left"><b><?php echo $data['price']; ?></b></p>
                            <span class="pull-right"><a href="add_cart.php?id=<?php echo $data['id']; ?>" class="btn btn-primary btn-sm"><span class="glyphicon glyphicon-plus"></span> Cart</a></span>
                        </div>
                    </div>
                </div>
            </div>
